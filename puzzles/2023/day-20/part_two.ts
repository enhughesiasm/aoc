...
// TODO
// this one is gross and I hate it - part 1 was so fun, and part 2
// is just inspecting the input for cycles and finding LCM again :(
...
const internalSolve = (lines: string[]) => {
